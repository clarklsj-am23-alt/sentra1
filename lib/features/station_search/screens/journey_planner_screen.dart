...
class _JourneyPlannerScreenState extends State<JourneyPlannerScreen> {
  ...
  void _findRoute() {
    if (_origin == _destination) {
      _showError('Origin and destination cannot be the same.');
      return;
    }
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: const Text('Station Accessibility'),
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const StationFacilitiesScreen(),
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const DelayReportScreen(),
                    ),
                  );
                },
              ),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: const OutlineInputBorder(
                          borderSide: BorderSide(color: appYellow, width: 2),
                        ),
                      ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRouteStep(
                        ...
                        title: 'Start at $_origin',
                        subtitle: 'Begin your journey from $_origin.',
                      ),
                        ...
                        child: OutlinedButton.icon(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => StationFacilitiesScreen(
                                  initialStation: _destination,
                                ),
                              ),
                            );
                          ...
                          label: const Text('Check Destination Accessibility'),
                        ),
                      ),
                    ],
                  ),
